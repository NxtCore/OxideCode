...
import com.oxidecode.utils.hasAnyFocusedDescendant
import java.awt.*
...
open class RoundedPanel(
    ...
    Disposable,
    Hoverable {
    open var borderColor: Color? = OxideCodeColors.borderColor
    open var activeBorderColor: Color? = OxideCodeColors.borderColor
    ...
    var hoverBackgroundColor: Color = OxideCodeColors.createHoverColor(OxideCodeColors.backgroundColor, 0.05f)
