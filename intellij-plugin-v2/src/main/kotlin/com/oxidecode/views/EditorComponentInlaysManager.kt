...
import com.oxidecode.utils.ComponentResizedAdapter
 ...
 * via https://github.com/kevinlu1248/continue/blob/main/extensions/intellij/src/main/kotlin/com/github/continuedev/continueintellijextension/editor/EditorComponentInlaysManager.kt
 */
class EditorComponentInlaysManager(
    val editor: EditorImpl,
    private val onlyOneInlay: Boolean,
) : Disposable {
    ...
    fun insert(
        ...
        val wrappedComponent = ComponentWrapper(component, maxWidth)
        ...
        return EditorEmbeddedComponentManager
            ...
            .addComponent(
                ...
                EditorEmbeddedComponentManager.Properties(
                    ...
                    null,
                    editor.inlayModel.getBlockElementsInRange(offset, offset).isNotEmpty(),
                    showAbove,
                    0,
                    offset,
                ),
    ...
    private inner class ComponentWrapper(
        ...
        private val fixedMaxWidth: Int? = null,
        ...
        init {
            ...
            // to prevent the component being treated as part of the editor
            ...
            component.addComponentListener(
                ComponentResizedAdapter {
                    ...
                    // Force the editor to update immediately
        ...
        override fun getPreferredSize(): Dimension {
            val width = fixedMaxWidth ?: editor.contentComponent.width
            return Dimension(width, component.preferredSize.height)
        }
    }
    ...
    override fun dispose() {
        ...
        try {
            ...
            // Editor may already be disposed, ignore
            // REMOVE THIS PRINTLN WHEN MERGIN
        }
    }
    ...
    private inner class EditorTextWidthWatcher : ComponentAdapter() {
        ...
        init {
            ...
            verticalScrollbarFlipped =
                scrollbarFlip == JBScrollPane.Flip.HORIZONTAL ||
