...
import com.oxidecode.theme.withAlpha
import com.oxidecode.utils.contrastWithTheme
import java.awt.*
    ...
    override fun paint(
        ...
        val backgroundColor =
            editor.colorsScheme.defaultBackground
                .brighter()
                .withAlpha(0.8f)
        val borderColor = OxideCodeColors.foregroundColor.withAlpha(0.3f)
        ...
        g2d.color = OxideCodeColors.foregroundColor.withAlpha(0.1f) // More translucent foreground color
        ...
        g2d.color = if (isDarkMode) OxideCodeColors.foregroundColor.withAlpha(0.8f) else OxideCodeColors.foregroundColor
    ...
    fun createJumpHintComponent(): JComponent =
        object : JComponent() {
            override fun paintComponent(g: Graphics) {
                ...
                g2d.color = OxideCodeColors.foregroundColor.withAlpha(0.1f)
                g2d.fillRoundRect(tabX, tabY, tabWidth + tabHorizontalPadding * 2, tabHeight, 4, 4)
