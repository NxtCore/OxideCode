...
import com.oxidecode.utils.isAllAdditions
import com.oxidecode.views.PopupEditorComponent
        ...
        override fun show(
            ...
            val attributes =
                TextAttributes().apply {
                    ...
                    backgroundColor =
                        if (forceHighlight || isPureWhitespace) OxideCodeColors.whitespaceHighlightColor else OxideCodeColors.transparent
                    effectType = null
                    fontType = Font.PLAIN
                }
            ...
            if (firstLineContent.isNotEmpty()) {
                ...
                // Register renderer as disposable child using OxideCodeProjectService as parent
                val parentDisposable =
                    editor.project?.let {
                        OxideCodeProjectService.getInstance(it)
