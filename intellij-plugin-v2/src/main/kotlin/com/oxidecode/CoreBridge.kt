...
class CoreBridge {
    init {
        ...
        try {
            initLogging()
            LOG.info("OxideCode native logging initialized")
        } catch (e: Throwable) {
            LOG.warn("Failed to initialize native logging: ${e.message}", e)
        }
    }
    ...
    companion object {
        ...
        private fun loadNativeLibrary() {
            ...
            val stream =
                CoreBridge::class.java.getResourceAsStream(resourcePath)
